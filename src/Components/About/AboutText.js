...
const AboutText = () => {
  ...
  return (
    <div className={aboutText}>
      ...
      times are highly dependent on the performance of the user's internet connection and local machine. Future plans
      for this project involve integration with Heroku or other Cloud platforms to store and pre-process data before
      sending results to the user which should significantly improve load times.
